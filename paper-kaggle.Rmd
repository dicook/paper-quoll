...
Occasionally, inventors of new methods and algorithms use Kaggle competitions as a platform to prove the superiority of their methods. A famous example are Geoffrey Hinton and George Dahl with deep neural networks and Tianqi Chen and Carlos Guestrin with XGBoost.
...
```{r crossperformances, echo=FALSE, fig.cap="\\label{fig:crossperformances} Students performance in classification and regression questions by competition type. Each quarter of the plot also contains  the counted number of students in the brackets. The number of students that participated in the classification competition is shown first, followed by the number of students that took part in the  regression competition. ", fig.width=6,fig.height=5  } 
...
ggplot() +
      annotate("rect", xmin = 0, xmax = 0.99, ymin = 1.01, ymax = 2, fill = "yellow", alpha = 0.3) +
      annotate("rect", xmin = 1.01, xmax = 2, ymin = 0, ymax = 0.99, fill = "yellow", alpha = 0.3) +
      ...
      annotate("text", x = c(0.2,0.2,1.7,1.7), y=c(0.1,1.9,1.9,0.1), 
               label = c(  a,  #(1,1)
                           b,  # "(2,2)"
                           c,  #"(3,3)"
                           d )) +

...
```{r Monash_quiz, fig.cap = "\\label{fig:Monash_quiz}Beeswarm plots of undergraduate (ST-UG) and postgraduate (ST-PG) students quizzes during the semester. The scores are very similar, although undergraduates have a longer lower tail.", fig.height=4, fig.width=6}
library(tidyverse)
library(gridExtra)
library(ggbeeswarm)
library(forcats)

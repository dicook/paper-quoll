...
ggplot(UniMelbData, aes(x=perf_class, y=perf_reg, color = Proj_alloc)) +
      geom_point() +
      ylab("Regression questions performance") + 
      xlab("Classification questions performance") +
      theme(legend.position="bottom") +
      xlim(0,2) + ylim(0, 2) +
      scale_color_discrete(name="Competiotion", 
      ...
      annotate("text", x = c(0.1,0.1,1.9,1.9), y=c(0.1,1.9,1.9,0.1), 
               label = c(  a,  #(1,1)
                           b,  # "(2,2)"
                           c,  #"(3,3)"
                           d )) #"(4,4)"

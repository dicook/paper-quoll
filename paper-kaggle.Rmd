---
title: A study on student performance, engagement and experience with Kaggle-in-class data challenges
...
Students mostly agree that taking part in data competition improved their understanding of the covered material (Q3) and their skills to apply the covered material to real problems (Q5). Surprisingly, they didn't perceive the Kaggle challenge to be related to exam performance (Q4). Perhaps the link between the two should be emphasised by the teaching stuff when the competition is presented to students. We believe that by increasing students' awareness of the linkage between the knowledge obtained from the data competition, better understanding of the material and better marks, further increases students' engagement with the competition. This, in turn, will positively reflect on their exam scores. 

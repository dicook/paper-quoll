...
Response rate was 55%, with 34 of 61 students completed the survey.

```{r likert, fig.caption="Stacked bar charts of responses to survey."}
...
```{r eval=FALSE}
# Di's survey
# Check that they agreed to the use of this data, Q2
# Qs
...
# Q7. What was your favorite topic in this subject during the semester?
# Q8. How heavily have you been involved in the submissions? Rate from 1 to 5 (1-not involved at all, 5- very much involved).
# Q9. Your level of involvement in the submissions, compared to your team members, was
# Q10. How heavily have you been involved in the model development? Rate from 1 to 5 (1-not involved at all, 5- very much involved).
# Q11. Your involvement in the model development, compared to your team members, was
MAST90083_survey <- read_xlsx("data/Data Competition Feedback MAST90083.xlsx") %>% filter(`Email Address` != "julia.polak@unimelb.edu.au")
MAST90083_survey %>% count(`1. I found the data competition is great fun.`)
MAST90083_survey %>% count(`2. Taking part in the data competition contributed a lot to my engagement with the subject.`)
MAST90083_survey %>% count(`3. Taking part in the data competition improved my confidence in my understanding of the covered material.`)
MAST90083_survey %>% count(`4. Taking part in the data competition improved my confidence in my success in the final exam.`)
MAST90083_survey %>% count(`5. Taking part in the data competition improved my confidence in my ability to use the acquired knowledge in practical applications.`)
MAST90083_survey %>% count(`6. I feel that the required time investment in the data competition was worthy.`)
MAST90083_survey$`7. What was your favorite topic in this subject during the semester?`
MAST90083_survey %>% count(`8. How heavily have you been involved in the submissions? Rate from 1 to 5 (1-not involved at all, 5- very much involved).` )
MAST90083_survey %>% count(`9. Your level of involvement in the submissions, compared to your team members, was`)
MAST90083_survey %>% count(`10. How heavily have you been involved in the model development? Rate from 1 to 5 (1-not involved at all, 5- very much involved).` )
MAST90083_survey %>% count(`11. Your involvement in the model development, compared to your team members, was`)
```

### ETC5242

The response rate was 50%, 17 students out of 34 completed the survey.
...
ETC5242_survey %>% count(`1. I found the data competition is great fun.`)
ETC5242_survey %>% count(`2. Taking part in the data competition contributed a lot to my engagement with the subject.`)
ETC5242_survey %>% count(`3. Taking part in the data competition improved my confidence in my understanding of the covered material.`)
ETC5242_survey %>% count(`4. Taking part in the data competition improved my confidence in my success in the final exam.`)
ETC5242_survey %>% count(`5. Taking part in the data competition improved my confidence in my ability to use the acquired knowledge in practical applications.`)
ETC5242_survey %>% count(`6. I feel that the required time investment in the data competition was worthy.`)
ETC5242_survey$`7. What was your favorite topic in this subject during the semester?`
ETC5242_survey %>% count(`8. How heavily have you been involved in the submissions? Rate from 1 to 5 (1-not involved at all, 5- very much involved).` )
ETC5242_survey %>% count(`9. Your level of involvement in the submissions, compared to your team members, was`)
ETC5242_survey %>% count(`10. How heavily have you been involved in the model development? Rate from 1 to 5 (1-not involved at all, 5- very much involved).` )
ETC5242_survey %>% count(`11. Your involvement in the model development, compared to your team members, was`)
...
# Q10. How heavily have you been involved in the model development? Rate from 1 to 5 (1-not involved at all, 5- very much involved).
# Q11. Your involvement in the model development, compared to your team members, was
ETC3250_survey <- read_xlsx("data/Data Competition Feedback ETC3250.xlsx") %>% filter(`Email Address` != "dicook@monash.edu") %>% filter(`Email Address` != "souhaib.bentaieb@monash.edu")
ETC3250_survey %>% count(`1. I found the data competition is great fun.`)
ETC3250_survey %>% count(`2. Taking part in the data competition contributed a lot to my engagement with the subject.`)
ETC3250_survey %>% count(`3. Taking part in the data competition improved my confidence in my understanding of the covered material.`)
ETC3250_survey %>% count(`4. Taking part in the data competition improved my confidence in my success in the final exam.`)
ETC3250_survey %>% count(`5. Taking part in the data competition improved my confidence in my ability to use the acquired knowledge in practical applications.`)
ETC3250_survey %>% count(`6. I feel that the required time investment in the data competition was worthy.`)
ETC3250_survey$`7. What was your favorite topic in this subject during the semester?`
ETC3250_survey %>% count(`8. How heavily have you been involved in the submissions? Rate from 1 to 5 (1-not involved at all, 5- very much involved).` )
ETC3250_survey %>% count(`9. Your level of involvement in the submissions, compared to your team members, was`)
ETC3250_survey %>% count(`10. How heavily have you been involved in the model development? Rate from 1 to 5 (1-not involved at all, 5- very much involved).` )
ETC3250_survey %>% count(`11. Your involvement in the model development, compared to your team members, was`)
```
...
- Copies of relevant exam questions
